...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def test_invalid_change_address(self):
        ...
        # !ALPHA
        assert_raises_rpc_error(-5, "Change address must be a valid alpha address", self.nodes[2].fundrawtransaction, rawtx, changeAddress='foobar')
        # !ALPHA END
    ...
    def test_option_feerate(self):
        ...
        # !ALPHA
        assert_raises_rpc_error(-8, "Cannot specify both fee_rate (sat/vB) and feeRate (ALPHA/kvB)",
        # !ALPHA END
