...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_specified_wallet_compiled():
            ...
            # !ALPHA
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (ALPHA/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (ALPHA/kvB)']), network_info['relayfee'])
            # !ALPHA END
