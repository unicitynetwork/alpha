...
class SettingsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # !ALPHA
        conf = node.datadir_path / 'alpha.conf'
        # !ALPHA END

        # Assert default settings file was created
        self.stop_node(0)
        # !ALPHA
        default_settings = {"_warning_": "This file is automatically generated and updated by alpha. Please do not edit this file while the node is running, as any changes might be ignored or overwritten."}
        # !ALPHA END
