...
# Copyright (c) The Unicity developers
...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def set_test_params(self):
        ...
        # !ALPHA
        self.extra_args = [["-walletrbf=1"]]  # alpha sets default to false, test assumes true
        # !ALPHA END
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # !ALPHA
        self.assert_raises_tool_error('No method provided. Run `alpha-wallet -help` for valid methods.')
        # !ALPHA END
