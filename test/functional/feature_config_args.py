...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        # !ALPHA
        with open(self.nodes[0].datadir_path / 'alpha.conf', 'a', encoding='utf-8') as conf:
        # !ALPHA END
    ...
    def test_config_file_log(self):
        ...
        # !ALPHA
        conf_path = default_datadir / 'alpha.conf'
        # !ALPHA END
    ...
    def test_ignored_conf(self):
        ...
        node.assert_start_raises_init_error([f"-conf={temp_conf.name}"], re.escape(
            # !ALPHA
            f'Error: Data directory "{node.datadir_path}" contains a "alpha.conf" file which is ignored, because a '
            # !ALPHA END
        ...
        # error.
        # !ALPHA
        self.start_node(0, [f'-conf={node.datadir_path}/alpha.conf'])
        # !ALPHA END
        self.stop_node(0)
    ...
    def test_ignored_default_conf(self):
        ...
        node = self.nodes[0]
        # !ALPHA
        (default_datadir / 'alpha.conf').write_text(f"datadir={node.datadir_path}\n")
        # !ALPHA END
        ...
        node.assert_start_raises_init_error([], re.escape(
            # !ALPHA
            f'Error: Data directory "{node.datadir_path}" contains a "alpha.conf" file which is ignored, because a '
            f'different configuration file "{default_datadir}/alpha.conf" from data directory "{default_datadir}" '
            # !ALPHA END
    ...
    def test_acceptstalefeeestimates_arg_support(self):
        ...
        # !ALPHA
        conf_file = self.nodes[0].datadir_path / 'alpha.conf'
        # !ALPHA END
        #! ALPHA
    ...
    def run_test(self):
        ...
        # !ALPHA
        conf_file = default_data_dir / 'alpha.conf'
        # !ALPHA END
