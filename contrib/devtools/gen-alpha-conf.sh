...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/alpha.conf}
...
then
  ...
  echo -e "To safely generate a alpha.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example alpha.conf file in share/examples/'
