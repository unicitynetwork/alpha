...
// !ALPHA
const std::string EXAMPLE_ADDRESS[2] = {"alpha1qszrk8tlw87204xl2mhw3d4d4gypz9ytalzk8rq", "alpha1qdqh2zcph5nqqlhk2cnrf3lrfs4s4k0j2eczuq6"};
// !ALPHA END
...
{
    // !ALPHA
    return "> alpha-cli " + methodname + " " + args + "\n";
    // !ALPHA END
}
...
{
    // !ALPHA
    std::string result = "> alpha-cli -named " + methodname;
    // !ALPHA END
