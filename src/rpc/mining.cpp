...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            // !ALPHA
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated Alpha to."},
            // !ALPHA END
        ...
        "Mine to a specified address and return the block hashes.",
         {
             ...
             // !ALPHA
             {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated Alpha to."},
             // !ALPHA END
             {"maxtries", RPCArg::Type::NUM, RPCArg::Default{DEFAULT_MAX_TRIES}, "How many iterations to try."},
         },
         RPCResult{
         ...
         RPCExamples{
            ...
            // !ALPHA
            + "If you are using the " PACKAGE_NAME " wallet, you can get a new address to send the newly generated Alpha to with:\n"
            // !ALPHA END
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            // !ALPHA
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated ALpha to."},
            // !ALPHA END
