    ...
    return
         {
             ...
             // !ALPHA
             {RPCResult::Type::STR, "address", /*optional=*/true, "The Alpha address (only if a well-defined address exists)"},
             // !ALPHA END
        ...
        {"outputs", RPCArg::Type::ARR, RPCArg::Optional::NO, "The outputs specified as key-value pairs.\n"
                ...
                "                             accepted as second parameter.",
            {
                {"", RPCArg::Type::OBJ_USER_KEYS, RPCArg::Optional::OMITTED, "",
                    {
                        // !ALPHA
                        {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "A key-value pair. The key (string) is the Alpha address, the value (float or string) is the amount in " + CURRENCY_UNIT},
                        // !ALPHA END
                    },
                },
                {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{
        "decodepsbt",
        // !ALPHA
        "Return a JSON object representing the serialized, base64-encoded partially signed Alpha transaction.",
        // !ALPHA END
                {
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                // !ALPHA
                "\nCombine multiple partially signed Alpha transactions into one transaction.\n"
                // !ALPHA END
