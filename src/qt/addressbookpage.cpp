    ...
    tab(_tab)
{
    ...
    case SendingTab:
        // !ALPHA
        ui->labelExplanation->setText(tr("These are your Alpha addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        // !ALPHA END
    ...
    case ReceivingTab:
        // !ALPHA
        ui->labelExplanation->setText(tr("These are your Alpha addresses for receiving payments. Use the 'Create new receiving address' button in the receive tab to create new addresses.\nSigning is only possible with addresses of the type 'legacy'."));
        // !ALPHA END
