...
void AskPassphraseDialog::accept()
{
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 // !ALPHA
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR ALPHA</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                 // !ALPHA END
        ...
        if(retval == QMessageBox::Yes)
        {
            if(newpass1 == newpass2)
            {
                ...
                // !ALPHA
                "your ALPHA from being stolen by malware infecting your computer.");
                // !ALPHA END
                if (m_passphrase_out) {
