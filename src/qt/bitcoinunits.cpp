...
QString BitcoinUnits::longName(Unit unit)
{
    switch (unit) {
    // !ALPHA
    case Unit::BTC: return QString("ALPHA");
    case Unit::mBTC: return QString("mALPHA");
    case Unit::uBTC: return QString::fromUtf8("µALPHA (bits)");
    // !ALPHA END
...
QString BitcoinUnits::description(Unit unit)
{
    ...
    // !ALPHA
    case Unit::BTC: return QString("Alpha");
    case Unit::mBTC: return QString("Milli-Alpha (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Alpha (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    // !ALPHA END
