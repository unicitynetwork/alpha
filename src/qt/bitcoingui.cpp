...
void BitcoinGUI::createActions()
{
    ...
    // !ALPHA
    sendCoinsAction->setStatusTip(tr("Send coins to an Alpha address"));
    // !ALPHA END
    ...
    // !ALPHA
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and alpha: URIs)"));
    // !ALPHA END
    ...
    // !ALPHA
    signMessageAction->setStatusTip(tr("Sign messages with your Alpha addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Alpha addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Alpha Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Alpha Transaction from clipboard"));
    // !ALPHA END
    ...
    // !ALPHA
    openAction->setStatusTip(tr("Open an alpha: URI"));
    // !ALPHA END
    ...
    // !ALPHA
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible alpha command-line options").arg(PACKAGE_NAME));
    // !ALPHA END
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        // !ALPHA
        tooltip = tr("%n active connection(s) to alpha network.", "", count);
        // !ALPHA END
    } else {
        //: A substring of the tooltip.
