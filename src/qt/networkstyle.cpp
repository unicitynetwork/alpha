...
static const struct {
    ...
    // !ALPHA
    {ChainType::ALPHAMAIN, QAPP_APP_NAME_DEFAULT, 0, 0},
    {ChainType::ALPHATESTNET, QAPP_APP_NAME_ALPHA_TESTNET, 180, 30},
    {ChainType::ALPHAREGTEST, QAPP_APP_NAME_ALPHA_REGTEST, 80, 30},
...
{
    // !ALPHA
    std::string titleAddText = networkId == ChainType::ALPHAMAIN ? "" : strprintf("[%s]", ChainTypeToString(networkId));
    // !ALPHA END
