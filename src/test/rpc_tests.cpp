...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    // !ALPHA
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> alpha-cli -named test foo=bar b=true n=1\n");
    // !ALPHA END
    ...
    // test shell escape
    // !ALPHA
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> alpha-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> alpha-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> alpha-cli -named test foo='b ar'\n");
    // !ALPHA END
    ...
    // !ALPHA
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> alpha-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
    // !ALPHA END
    ...
    // !ALPHA
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> alpha-cli -named test name='[\"bar\",false,1]'\n");
    // !ALPHA END
