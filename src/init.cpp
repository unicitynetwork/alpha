 ...
 */
// !ALPHA
static const char* BITCOIN_PID_FILENAME = "alphad.pid";
// !ALPHA END
/**
...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    const auto alphaMainBaseParams = CreateBaseChainParams(ChainType::ALPHAMAIN);
    const auto alphaRegtestChainParams = CreateChainParams(argsman, ChainType::ALPHAREGTEST);
    const auto alphaTestnetChainParams = CreateChainParams(argsman, ChainType::ALPHATESTNET);
    const auto alphaMainChainParams = CreateChainParams(argsman, ChainType::ALPHAMAIN);
    // !ALPHA END
...
// !ALPHA
    argsman.AddArg("-bind=<addr>[:<port>][=onion]", strprintf("Bind to given address and always listen on it (default: 0.0.0.0). Use [host]:port notation for IPv6. Append =onion to tag any incoming connections to that address and port as incoming Tor connections (default: 127.0.0.1:%u=onion, testnet: 127.0.0.1:%u=onion, regtest: 127.0.0.1:%u=onion)",alphaMainBaseParams->OnionServiceTargetPort(), alphaTestnetBaseParams->OnionServiceTargetPort(), alphaRegtestBaseParams->OnionServiceTargetPort()), ArgsManager::ALLOW_ANY | ArgsManager::NETWORK_ONLY, OptionsCategory::CONNECTION);
// !ALPHA END
...
// !ALPHA
    argsman.AddArg("-port=<port>", strprintf("Listen for connections on <port>. Nodes not using the default ports (default: %u, testnet: %u, regtest: %u) are unlikely to get incoming connections. Not relevant for I2P (see doc/i2p.md).", alphaMainChainParams->GetDefaultPort(), alphaTestnetChainParams->GetDefaultPort(), alphaRegtestChainParams->GetDefaultPort()), ArgsManager::ALLOW_ANY | ArgsManager::NETWORK_ONLY, OptionsCategory::CONNECTION);
// !ALPHA END
...
// !ALPHA
    argsman.AddArg("-rpcport=<port>", strprintf("Listen for JSON-RPC connections on <port> (default: %u, testnet: %u, regtest: %u)", alphaMainBaseParams->RPCPort(), alphaTestnetBaseParams->RPCPort(), alphaRegtestBaseParams->RPCPort()), ArgsManager::ALLOW_ANY | ArgsManager::NETWORK_ONLY, OptionsCategory::RPC);
// !ALPHA END
